module.exports.run = (client, message, args) => {
  if (!message.channel.name.startsWith('ticket') || message.parentID !== client.config.ticketcategory) return message.reply(':x: You may only use this command in ticket channels!');
